...
DGV = "/media/hanjinu/SS200/db/refs/dgv/DGV_hg38_variants_2020-02-25_light.bed"
...
uniq = pandas.read_csv("/media/hanjinu/SS200/db/refs/genes_uniq/hg38_genes_uniq.bed", \
