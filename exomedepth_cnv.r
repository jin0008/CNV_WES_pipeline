...
targets_auto <- read.table(file="/media/hanjinu/PM883/db/refs/gencode/v44/autosomes/gencode.v36.basic.annotation.autosomes.bed",
                    header=FALSE, sep=" ", as.is=TRUE)

targets_XY <- read.table(file="/media/hanjinu/PM883/db/refs/gencode/v44/XY/gencode.v36.basic.annotation.XY.bed",
                    header=FALSE, sep=" ", as.is=TRUE)
